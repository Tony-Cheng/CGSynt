...
public class RTwo {
	...
	public RTwo(final CfgSmtToolkit cfgSmtToolkit, final PredicateFactory predicateFactory,
	...
	public ImpRootNode convert(final IIcfg<BoogieIcfgLocation> oldIcfg) {
		final ImpRootNode newRoot = new ImpRootNode();

		final Deque<IcfgLocation> openNodes = new ArrayDeque<>();
		mOldPp2New = new HashMap<>();

		for (final Entry<String, BoogieIcfgLocation> entry : oldIcfg.getProcedureEntryNodes().entrySet()) {
