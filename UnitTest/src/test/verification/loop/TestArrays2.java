...
public class TestArrays2 {
	...
	// ">=");
	// IAssumption pre3 = new ScriptAssumptionStatement(m, script.term("select",
	...
	// IStatement mleai = new ScriptAssumptionStatement(m, script.term("select",
	// A.getTerm(), i.getTerm()), "<");
	// IStatement mgeai = new ScriptAssumptionStatement(m, script.term("select",
	// A.getTerm(), i.getTerm()), ">=");
	//
	...
	// IAssumption post = new ScriptAssumptionStatement(m, script.term("select",
	// A.getTerm(), i.getTerm()), ">=");
	//
	// // Create Meta Alphabet for LTA
	// List<IStatement> letters = Arrays.asList(ilen, igen, mleai, mgeai, meai,
	// ipp);
	//
	...
	//
	// List<IAssumption> preconditions = Arrays.asList(pre1, pre2, pre3, pre4,
	// pre5);
