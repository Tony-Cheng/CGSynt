...
public class TestBuchiParityIntersectionV2 {
	...
	void test1() {
		...
		BuchiParityIntersectAutomatonV2<RankedBool, String, ParityState<String>> aut3 = new BuchiParityIntersectAutomatonV2<>(
				aut1, aut2);
