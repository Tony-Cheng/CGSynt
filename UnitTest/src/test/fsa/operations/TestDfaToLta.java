...
import cgsynt.dfa.operations.DfaToLtaLanguage;
...
class TestDfaToLta {
	...
	// NestedWordAutomaton<Character, String> dfa =
	// FsaFactory.fiveStateDFA(service);
	//
	...
	// Collection<BuchiTreeAutomatonRule<LtaBool, String>> rules =
	// lta.getRulesBySource(state);
	//
